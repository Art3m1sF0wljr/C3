...
class test_9_merge_RTX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_sink_0 = osmosdr.sink(
            args="numchan=" + str(1) + " " + "bladerf=0,nchan=1,biastee=1"
        )
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/home/art3m1sf0wl/program/TRX_test/test.txt', True, 0, 0)
        self.blocks_file_source_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/art3m1sf0wl/program/TRX_test/c3/qpsk/test_12_QPSK_output.txt', True)
        ...
        self.connect((self.blocks_throttle_0_1, 0), (self.blocks_stream_to_tagged_stream_0, 0))
