...
class test_12_QPSK_TRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_12_QPSK_TRX")
        ...
        self.TX_rf_gain = TX_rf_gain = 30
        self.RX_rf_gain = RX_rf_gain = 30
        ...
        # Connections
        ##################################################
        self.msg_connect((self.digital_crc32_async_bb_0, 'out'), (self.pdu_pdu_to_tagged_stream_1, 'pdus'))
...
def main(top_block_cls=test_12_QPSK_TRX, options=None):
